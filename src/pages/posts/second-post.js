...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'src', 'pages', 'posts', 'second-post.md');
    ...
    return (
      <Layout className="bg-black text-white">
        ...
        <div className="w-full max-w-[80%] ml-auto text-right px-[10px]">
          <h1 className="text-4xl font-bold mb-4 text-white">Why I love Ring Buffer Registries</h1>
          <p className="text-gray-400 mb-6">TBC, 2025</p>
        </div>
